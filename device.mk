...
# Audio
$(call project-set-path,qcom-audio,device/oneplus/oneplus3/audio)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/configs/audio_output_policy.conf:system/vendor/etc/audio_output_policy.conf \
    ...
    $(LOCAL_PATH)/audio/configs/mixer_paths_tasha.xml:system/etc/mixer_paths_tasha.xml \
    $(LOCAL_PATH)/audio/configs/sound_trigger_mixer_paths_wcd9330.xml:system/etc/sound_trigger_mixer_paths_wcd9330.xml \
    $(LOCAL_PATH)/audio/configs/sound_trigger_mixer_paths.xml:system/etc/sound_trigger_mixer_paths.xml \
    $(LOCAL_PATH)/audio/configs/sound_trigger_platform_info.xml:system/etc/sound_trigger_platform_info.xml
